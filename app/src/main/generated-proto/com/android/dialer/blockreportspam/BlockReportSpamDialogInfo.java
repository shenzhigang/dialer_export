...
// source: java/com/android/dialer/blockreportspam/block_report_spam_dialog_info.proto
  ...
  protected final Object dynamicMethod(
    ...
    switch (method) {
      ...
      case VISIT: {
        ...
        com.android.dialer.blockreportspam.BlockReportSpamDialogInfo other = (com.android.dialer.blockreportspam.BlockReportSpamDialogInfo) arg1;
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 32: {
                ...
                com.android.dialer.logging.ReportingLocation.Type value = com.android.dialer.logging.ReportingLocation.Type.forNumber(rawValue);
                if (value == null) {
      ...
      case GET_PARSER: {
        if (PARSER == null) {    synchronized (com.android.dialer.blockreportspam.BlockReportSpamDialogInfo.class) {
            if (PARSER == null) {
