...
// source: java/com/android/dialer/historyitemactions/history_item_action_module_info.proto
  ...
  protected final Object dynamicMethod(
    ...
    switch (method) {
      ...
      case VISIT: {
        ...
        com.android.dialer.historyitemactions.HistoryItemActionModuleInfo other = (com.android.dialer.historyitemactions.HistoryItemActionModuleInfo) arg1;
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 112: {
                ...
                com.android.dialer.logging.ContactSource.Type value = com.android.dialer.logging.ContactSource.Type.forNumber(rawValue);
                if (value == null) {
              ...
              case 120: {
                int rawValue = input.readEnum();
                com.android.dialer.historyitemactions.HistoryItemActionModuleInfo.Host value = com.android.dialer.historyitemactions.HistoryItemActionModuleInfo.Host.forNumber(rawValue);
                if (value == null) {
      ...
      case GET_PARSER: {
        if (PARSER == null) {    synchronized (com.android.dialer.historyitemactions.HistoryItemActionModuleInfo.class) {
            if (PARSER == null) {
