...
// source: java/com/android/dialer/rtt/rtt_transcript.proto
  ...
  protected final Object dynamicMethod(
    ...
    switch (method) {
      ...
      case VISIT: {
        ...
        com.android.dialer.rtt.RttTranscript other = (com.android.dialer.rtt.RttTranscript) arg1;
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 34: {
                ...
                messages_.add(
                    input.readMessage(com.android.dialer.rtt.RttTranscriptMessage.parser(), extensionRegistry));
                break;
              }
            }
          }
      ...
      case GET_PARSER: {
        if (PARSER == null) {    synchronized (com.android.dialer.rtt.RttTranscript.class) {
            if (PARSER == null) {
